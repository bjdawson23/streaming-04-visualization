...
from streaming.data_validation.data_contract_dawson import (
    CONSUMED_FIELDNAMES,
    SALES_REQUIRED_FIELDS,
    validate_required_fields,
)
from streaming.visualizations.live_visualizations_dawson import (
    close_live_chart,
    init_live_chart,
    save_live_chart,
    update_live_chart,
...
MAX_MESSAGES: Final[int] = int(os.getenv("CONSUMER_MAX_MESSAGES", "20"))
...
OUTPUT_CHART: Final[Path] = OUTPUT_DIR / "sales_chart_dawson.png"
